...
class QuantCalc(FindCode, Calculate):
	...
	def execute(self):
		codes = self.apply_conditions(start_date=datetime(2018,1,1), end_date=None, \
									term=6, market=None, main_sector=None, net_rev=None, \
									net_rev_r=None, net_prf=None, de_r=None, per=None, psr=None, \
									pbr=None, op_act=None, iv_act=None, fn_act=None, dv_yld=None, \
									dv_pay_r=None, roa=None, roe=None, marcap=None, vol=None, \
									pvol=None, sma5=None, sma20=None, sma60=None, sma120=None, \
									ema5=None, ema20=None, ema60=None, ema120=None, past_prf_r1=None, \
									past_prf_r3=None, past_prf_r6=None, past_prf_r12=None)
